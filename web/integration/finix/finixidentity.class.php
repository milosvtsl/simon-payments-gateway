...
class FinixIdentity
{
    ...
    public function createMerchantIdentity(MerchantRow $M) {
        $FinixIntegration = Model\IntegrationRow::fetchByUID(FinixConfig::$UID);

        $url = $FinixIntegration->getAPIURLBase() . self::POST_URL;
        $userpass = $FinixIntegration->getAPIUsername() . ':' . $FinixIntegration->getAPIPassword();
        $type = "Content-Type: application/vnd.json+api";
        $POST = array(
            'tags' => array(
                'key' => 'value'
            ),
            'entity' => array(
                ...
                "default_statement_descriptor" => $M->getName(),                    // "Golds Gym",
...
3223 COMAIR
3228 CAYMAN AIRWAYS
3229 SAETA SOCIAEDAD ECUATORIANOS DE TRANSPORTES
AEREOS
...
4111 Local/Suburban Commuter Passenger Transportation – Railroads,
Feries, Local Water Transportation.
...
MCC MERCHANT TYPE
4814 Fax services
4814 Telecommunication service including local and long distance calls,
credit card calls, calls through use of magnetic-strip reading
...
5511 Car and Truck Dealers (New and Used) Sales, Service, Repairs,
Parts, and Leasing
...
5712 Furniture, Home Furnishings, and Equipment Stores, Except
Appliances
...
5813 Drinking Places (Alcoholic Beverages), Bars, Taverns, Cocktail
lounges, Nightclubs and Discotheques
...
Clubs (No longer permitted for U.S. original presentments)
...
6051 Non-Financial Institutions – Foreign Currency, Money Orders (not
...
7251 Shop Repair Shops and Shoe Shine Parlors, and Hat Cleaning
Shops
...
7372 Computer Programming, Integrated Systems Design and Data
Processing Services
7375 Information Retrieval Services
7379 Computer Maintenance and Repair Services, Not Elsewhere
Classified
7392 Management, Consulting, and Public Relations Services
7393 Protective and Security Services – Including Armored Cars and
Guard Dogs
7394 Equipment Rental and Leasing Services, Tool Rental, Furniture
Rental, and Appliance Rental
...
7929 Bands, Orchestras, and Miscellaneous Entertainers (Not
Elsewhere Classified)
7932 Billiard and Pool Establishments
7933 Bowling Alleys
7941 Commercial Sports, Athletic Fields, Professional Sport Clubs, and
Sport Promoters
...
8044 Opticians, Optical Goods, and Eyeglasses (no longer valid for first
presentments)
...
MCC MERCHANT TYPE
8099 Medical Services and Health Practitioners (Not Elsewhere
Classified)
